...
uv run run.py --per-gb 0.32       # re-price at the point where the ranking inverts
...
times smaller. The plan is the confounder: bigger plans cost more *and* come with
more data. Nothing errors, and a pricing team builds a usage-based add-on for a
...
the declared $0.12/GB the contribution ranking and the revenue ranking agree 96%.
The deliverable is not that number, it is where the answer flips: at **$0.15/GB**
the flagship tariff stops being the most profitable one, at **$0.32/GB** it falls
below the cheapest plan on the price list, and at **$0.34/GB** it stops covering
